...
rmarkdown::render("~/Downloads/exercise-06/exercise.Rmd")
...
naxstar_middle <- (-(rus_cd_middle$nx)/24)*(rus_cd_middle$nqxstar[-1])
rus_cd_middle$nqxstar[-1]
...
newdat %>% select(-c(2:19)) %>% datatable(
  rownames = FALSE,
  filter = "top",
